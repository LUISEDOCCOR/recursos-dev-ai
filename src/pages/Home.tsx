  ...
  return (
    <Layout>
      <div className="flex h-full w-full">
        <div className="fixed bottom-0 top-16 z-10 hidden w-96 space-y-8 border-r border-neutral-700 px-6 pt-12 md:block">
          <Options
        ...
        <div className="ml-0 w-full px-0 md:ml-96 xl:px-6">
